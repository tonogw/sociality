...
export default function NavbarProfile({
  ...
  return (
    <nav className="fixed top-0 w-full left-1/2 -translate-x-1/2 z-50 flex h-16  lg:h-20 max-w-98.25 lg:max-w-200 items-center border-b border-[#181D27] bg-black px-4">
      <button
        onClick={handleBack}
